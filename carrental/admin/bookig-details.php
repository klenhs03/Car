...
$query -> execute();
  echo "<script>alert('Hủy đặt xe thành công');</script>";
...
$query -> execute();
echo "<script>alert('Xác nhận đặt xe thành công');</script>";
...
<head>
	...
	<title>Hệ Thống Thuê Xe | Chi Tiết Đặt Xe</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Chi Tiết Đặt Xe</h2>
...
{?>	
	<h3 style="text-align:center; color:red">#<?php echo htmlentities($result->BookingNumber);?> Thông Tin Đặt Xe </h3>

		<tr>
														<th colspan="4" style="text-align:center;color:blue">Thông Tin Người Dùng</th>
													</tr>
													<tr>
														<th>Mã Đặt Xe</th>
													...
													<tr>
														<th colspan="4" style="text-align:center;color:blue">Thông Tin Đặt Xe</th>
													</tr>
														<tr>													
														<th>Tên Xe</th>
...
echo htmlentities('Đã xác nhận');
 	...
 	echo htmlentities('Đã hủy');
				...
				<a href="bookig-details.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn có chắc chắn muốn xác nhận đặt chỗ này không?')" class="btn btn-primary"> Xác nhận đặt</a> 

<a href="bookig-details.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn có chắc chắn muốn hủy đặt chỗ này không?')" class="btn btn-danger"> Hủy đặt</a>
</td>
</tr>
<?php } ?>
									<?php $cnt=$cnt+1; }} ?>
							...
							<form method="post">
   <input name="Submit2" type="submit" class="txtbox4" value="In" onClick="return f3();" style="cursor: pointer;"  />
	</form>
