...
<head>
    ...
    <title>Car Rental Portal | Admin Tạo Thương Hiệu</title>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Tạo Thương Hiệu</div>
                                        ...
                                        <form method="post" name="chngpwd" class="form-horizontal" onSubmit="return valid();">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-8 col-sm-offset-4">
                                                    ...
                                                    <button class="btn btn-primary" name="submit" type="submit">Tạo</button>
                                                </div>
                                            </div>
