...
if(isset($_REQUEST['eid']))
{
    ...
    $msg="Đánh giá đã được vô hiệu hóa thành công";
}
...
if(isset($_REQUEST['aeid']))
{
    ...
    $msg="Đánh giá đã được kích hoạt thành công";
}
?>
...
<head>
    ...
    <title>Hệ thống cho thuê xe | Quản lý đánh giá khách hàng</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Đánh giá của người dùng</div>
...
{
    ?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn có chắc chắn muốn kích hoạt?')"> Không kích hoạt</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn có chắc chắn muốn vô hiệu hóa?')"> Đang kích hoạt</a>
</td>
<?php } ?></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; }} ?>
