...
<head>
	...
	<title>Car Rental Portal | Admin Cập nhật Ảnh 4</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Ảnh Xe 4</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Chi tiết Ảnh Xe 4</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Ảnh Xe 4 Hiện Tại</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Tải Ảnh Mới 4<span style="color:red">*</span></label>
												<div class="col-sm-8">
