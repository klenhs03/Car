			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Hình ảnh xe 5</h2>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Hình ảnh hiện tại 5</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Tải lên hình ảnh mới 5<span style="color:red">*</span></label>
												<div class="col-sm-8">
