...
{	
    ...
    if(isset($_POST['update']))
    {
        ...
        $msg="Hình ảnh đã được cập nhật thành công";
    }
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Hình ảnh xe 3</h2>

                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Chi tiết hình ảnh xe 3</div>
                                    <div class="panel-body">
                                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Hình ảnh hiện tại 3</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Tải lên hình ảnh mới 3<span style="color:red">*</span></label>
                                                <div class="col-sm-8">
