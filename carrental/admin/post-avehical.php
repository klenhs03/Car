...
<head>
	...
	<title>Cổng thông tin cho thuê xe | Quản trị viên đăng xe</title>
...
<div class="form-group">
<label class="col-sm-2 control-label">Giá Theo Ngày(USD)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="airconditioner"> Điều hòa không khí </label>
</div>
</div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="powerdoorlocks" name="powerdoorlocks" value="1">
<label for="powerdoorlocks"> Khóa cửa điện </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="antilockbrakingsys" name="antilockbrakingsys" value="1">
<label for="antilockbrakingsys"> Hệ thống phanh chống bó cứng </label>
</div></div>
<div class="checkbox checkbox-inline">
...
<input type="checkbox" id="powersteering" name="powersteering" value="1">
<label for="inlineCheckbox5"> Tay lái trợ lực </label>
</div>
</div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="driverairbag" name="driverairbag" value="1">
<label for="driverairbag"> Túi khí người lái </label>
</div>
</div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="passengerairbag" name="passengerairbag" value="1">
<label for="passengerairbag"> Túi khí hành khách </label>
</div></div>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="powerwindow" name="powerwindow" value="1">
<label for="powerwindow"> Cửa sổ điện </label>
</div>
</div>
...
<label for="cdplayer"> Đầu đĩa CD </label>
</div>
</div>
<div class="col-sm-3">
...
<label for="crashcensor"> Cảm biến va chạm </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="leatherseats" name="leatherseats" value="1">
<label for="leatherseats"> Ghế bọc da </label>
</div>
</div>
</div>
