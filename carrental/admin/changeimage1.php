...
<head>
	...
	<title>Cổng thông tin Thuê Xe | Quản trị Cập nhật Hình ảnh 1</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Hình ảnh Xe 1 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Thông tin Hình ảnh Xe 1</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Hình ảnh hiện tại</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Tải lên Hình ảnh Mới 1<span style="color:red">*</span></label>
												<div class="col-sm-8">
