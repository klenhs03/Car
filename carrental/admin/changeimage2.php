...
$msg="Ảnh đã được cập nhật thành công";
}
?>
...
<head>
	...
	<title>Cổng thông tin cho thuê xe | Quản trị viên Cập nhật Ảnh 2</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Ảnh xe 2 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Chi tiết Ảnh xe 2</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Ảnh hiện tại 2</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Tải ảnh mới lên<span style="color:red">*</span></label>
												<div class="col-sm-8">
