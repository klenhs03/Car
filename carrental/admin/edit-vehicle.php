			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Chỉnh Sửa Xe</h2>
...
<div class="form-group">
<label class="col-sm-2 control-label">Tổng Quan Về Xe<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Giá Theo Ngày(in USD)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Chọn Loại Nguyên Liệu<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Mẫu Của Năm<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Đổi ảnh 1</a>
</div>
<div class="col-sm-4">
Ảnh 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Đổi ảnh 2</a>
</div>
<div class="col-sm-4">
Ảnh 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">Đổi ảnh 3</a>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Ảnh 4<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Đổi ảnh 4</a>
</div>
<div class="col-sm-4">
Ảnh 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Đổi ảnh 5</a>
<?php } ?>
</div>
...
<label for="inlineCheckbox1"> Máy điều hòa không khí </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">  Khóa cửa điện </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Hệ thống chống bó cứng phanh </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Hỗ trợ phanh </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Túi khí tài xế</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Túi khí hành khách </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Cửa sổ điện </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Máy nghe nhạc CD
</label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Khóa trung tâm</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3"> Cảm biến va chạm </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Lưu Thay Đổi</button>
												</div>
											</div>
