...
<head>
	...
	<title>Cổng Thuê Xe | Bảng Điều Khiển Quản Trị</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Người Dùng Đã Đăng Ký</div>
												</div>
											</div>
											<a href="reg-users.php" class="block-anchor panel-footer">Xem Chi Tiết <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
													...
													<div class="stat-panel-title text-uppercase">Xe Đã Đăng</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Tổng Số Đơn Đặt Xe</div>
												</div>
											</div>
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Thương Hiệu Xe</div>
												</div>
											</div>
