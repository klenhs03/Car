...
$query -> execute();
$msg="Dữ liệu xe đã được xóa thành công";
}
...
<head>
	...
	<title>Cổng Thuê Xe | Quản Lý Xe   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Quản Lý Xe</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Chi Tiết Xe</div>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Bạn có muốn xóa?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
