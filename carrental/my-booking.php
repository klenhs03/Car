...
<title>Cổng Thuê Xe - Đặt Xe Của Tôi</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Đặt Xe Của Tôi</h5>
...
<li>
    <h4 style="color:red">Số Đặt Xe #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <div class="vehicle_title">
                  ...
                  <div style="float: left"><p><b>Thông điệp:</b> <?php echo htmlentities($result->message);?> </p></div>
                </div>
...
<hr />
              <?php }}  else { ?>
                <h5 align="center" style="color:red">Chưa có đặt xe nào</h5>
              <?php } ?>
