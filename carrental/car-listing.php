        ...
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              ...
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> mẫu xe</li>
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Những xe gần đây</h5>
          </div>
