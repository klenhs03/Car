...
if($lastInsertId)
{
$msg="Câu hỏi đã được gửi. Chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất.";
}
else 
{
...
<title>Cho Thuê Xe || Trang Liên Hệ</title>
<!--Bootstrap -->
...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3>Liên hệ với chúng tôi qua mẫu dưới đây</h3>
