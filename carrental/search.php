...
<title>Cổng Thuê Xe | Danh Sách Xe</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Kết quả tìm kiếm từ khóa "<?php echo $_POST['searchdata'];?>"</h1>
      </div>
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Kết quả tìm kiếm</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">$<?php echo htmlentities($result->PricePerDay);?> mỗi ngày</p>
            <ul>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Tìm kiếm xe của bạn </h5>
          </div>
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Xe vừa được thêm gần đây</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">$<?php echo htmlentities($result->PricePerDay);?> mỗi ngày</p>
                </div>
              </li>
              <?php }} ?>
