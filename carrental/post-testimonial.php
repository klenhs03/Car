...
<title>Portal cho thuê xe | Đăng đánh giá</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Đăng đánh giá</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <button type="submit" name="submit" class="btn">Lưu  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
