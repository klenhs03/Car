...
?>   
            ...
            <div class="header_widgets">
              ...
              <p class="uppercase_text">Để được hỗ trợ, vui lòng gửi email đến: </p>
              <a href="mailto:<?php echo htmlentities($email);?>"><?php echo htmlentities($email);?></a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Hotline hỗ trợ: </p>
...
echo "Chào mừng đến với cổng thông tin cho thuê xe";
 } ?>
          </div>
        </div>
      </div>
  ...
  <nav id="navigation_bar" class="navbar navbar-default">
    <div class="container">
      <div class="navbar-header">
        <button id="menu_slide" data-target="#navigation" aria-expanded="false" data-toggle="collapse" class="navbar-toggle collapsed" type="button"> <span class="sr-only">Chuyển đổi điều hướng</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
      </div>
...
foreach($results as $result)
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <?php if($_SESSION['login']){?>
            ...
            <li><a href="my-booking.php">Đặt xe của tôi</a></li>
            <li><a href="post-testimonial.php">Đăng lời chứng thực</a></li>
          <li><a href="my-testimonials.php">Lời chứng thực của tôi</a></li>
